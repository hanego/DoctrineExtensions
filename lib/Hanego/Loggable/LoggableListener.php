...
class LoggableListener extends MappedEventSubscriber
{
    ...
    public function setUser($user)
    {
        if (is_object($user) && method_exists($user, 'getUsername')) {
            ...
            throw new \Gedmo\Exception\InvalidArgumentException("User must be an object");
        }
    }
     ...
     * @param LoggableAdapter $ea
     *
     * @return \Hanego\Loggable\Entity\MappedSuperclass\AbstractLogEntry|null
     */
